                    ...
                    {filteredQuestions.map(q => {
                      ...
                      return (
                        <div key={q.id} style={{
                          ...
                          <div style={{ flex: 1, minWidth: 0 }} onClick={() => setTestPreviewQuestion(isPreviewing ? null : q)}>
                          ...
                          {/* Preview button */}
                          <button onClick={(e) => { e.stopPropagation(); setTestPreviewQuestion(isPreviewing ? null : q); }} style={{
                            background: isPreviewing ? colors.secondary : "#f1f5f9", border: "none", borderRadius: 8,
                            padding: "6px 10px", fontSize: 12, fontWeight: 700, cursor: "pointer",
                            color: isPreviewing ? "white" : colors.textLight, transition: "all 0.15s", flexShrink: 0,
                          }}>
